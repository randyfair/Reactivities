  ...
  return (
    <Segment clearing>
      <Form onSubmit={handleSubmit} autoComplete='off'>
        ...
        <FormInput placeholder='Sponsor' value={activity.sponsor} name='sponsor' onChange={handleInputChange}/>
        <FormInput placeholder='POC' value={activity.poc} name='poc' onChange={handleInputChange}/>
